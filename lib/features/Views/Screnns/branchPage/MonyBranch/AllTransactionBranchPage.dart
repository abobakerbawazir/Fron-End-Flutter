...
class AllTransactionBranchPage extends StatefulWidget {
  const AllTransactionBranchPage({super.key});

  @override
  State<AllTransactionBranchPage> createState() =>
      _AllTransactionBranchPageState();
}

class _AllTransactionBranchPageState extends State<AllTransactionBranchPage> {
