...
class WithdrawBranchPage extends StatefulWidget {
  const WithdrawBranchPage({super.key});

  @override
  State<WithdrawBranchPage> createState() => _WithdrawBranchPageState();
}

class _WithdrawBranchPageState extends State<WithdrawBranchPage> {
