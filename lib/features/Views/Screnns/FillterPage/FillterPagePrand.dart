              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                        onPressed: () {
                          prandProvider.nameController.text = '';
                          setState(() {
                            prandProvider.nameController.clear();
                          });
                        },
                        ...
                        child: Card(
                          child: Directionality(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  prandProvider.changeName(value);
                                  // prandProvider.titleController.text = value;
                                },
                              )),
                        )),
                  ],
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder(
                      future: prandProvider.filtterPrandName(
                          fultterName: prandProvider.nameController.text),
                                ...
                                return SizedBox(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        color:
                                            Color.fromARGB(255, 210, 215, 216),
                                        borderRadius:
